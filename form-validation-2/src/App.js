...
const greaterThanField = (fieldName) => (fieldValue, state) =>
    fieldValue > state[fieldName] ? undefined : `Value must be greater than ${fieldName}`;
            ...
            <div className="App">
                <form>
                    <div className="input-field">
                        ...
                        <input type="number" name="Price" value={this.state.form.price}
                            onChange={(e) => this.handleChange(e, "price")} />
                        <span className="error-message">{this.state.error.price}</span>
                    </div>
                    <div className="input-field">
                        <label hrmlFor="Quantity">Quantity</label>
                        <input type="number" name="Quantity" value={this.state.form.quantity}
                            onChange={(e) => this.handleChange(e, "quantity")} />
                        <span className="error-message">{this.state.error.quantity}</span>
                    </div>
                    <div className="input-field">
                        <label hrmlFor="Total Price">Total Price</label>
                        <input type="number" name="Total Price" value={this.state.form.totalPrice}
